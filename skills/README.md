...
| `pr-toolkit-check.yml` | PR su candidates/ e support/ | `toolkit run all` + `validate all` + gate blocker_hints |
| `post-merge-candidate.yml` | Merge su candidates/ e support/ | Run CI, rebuild `pipeline_signals.json`, apre draft PR handoff |
