#!/usr/bin/env python3
"""
build_graph.py — Genera il grafo entità → dataset dal catalogo annotato.

Legge catalog_annotated.json (prodotto da annotate.py) e produce un grafo
dove i nodi sono entità (Comune, Provincia, Ente...) e gli archi sono dataset
che le descrivono, con semantic_type e match rate.
