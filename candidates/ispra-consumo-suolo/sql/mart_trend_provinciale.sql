-- mart_trend_provinciale.sql — ispra_consumo_suolo
-- Trend annuale per provincia del consumo di suolo (solo periodi annuali 2016-2024)
...
ORDER BY regione, provincia, anno DESC
