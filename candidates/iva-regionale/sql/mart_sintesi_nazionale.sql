...
-- VA fiscale, imposta dovuta/credito, più delta % vs anno precedente.
...
WITH all_clean AS (
    SELECT anno, contribuenti,
           volume_affari_eur, va_fiscale_eur,
...
SELECT
    ...
    ROUND(va_fiscale_eur / NULLIF(contribuenti, 0), 0) AS va_per_contribuente_eur,
