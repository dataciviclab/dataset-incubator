...
| project_candidates/dipendenti-pubblici-2021-2023 | candidate | intake | il pubblico impiego sta tornando a crescere davvero, e in quali comparti? | export CSV pubblico BDAP/RGS 2021-2023 per ente e comparto | mart per anno/comparto con stock, assunti, cessati, saldo e quota donne | decidere se entra come filone lavoro pubblico / PA in `dataciviclab/preanalysis` | eseguire `run all` e verificare il primo taglio pubblico |
