...
_REPO_CONFIG: dict[str, dict] = {
    "dataciviclab/dataciviclab": {
        ...
        "body": lambda slug, items, pr_ref, pr_number: (
            ...
            f"### Prossimo passo\n\n"
            f"Creare una pagina su [data-explorer](https://explorer.dataciviclab.org) "
            f"seguendo la [guida](https://github.com/dataciviclab/data-explorer/blob/main/CONTRIBUTING.md):\n\n"
            f"1. Branch `feat/{slug}` da main in data-explorer\n"
            f"2. Pagina dataset + data loader seguendo il template\n"
            f"3. PR verso main\n\n"
            f"### Riferimenti\n\n"
