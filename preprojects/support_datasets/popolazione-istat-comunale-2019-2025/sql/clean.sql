select
  ...
  try_cast("Eta" as integer) as eta,
  ...
  try_cast("Maschi gia in unione civile (per scioglimento unione)" as integer) as maschi_gia_unione_civile_scioglimento,
  try_cast("Maschi gia in unione civile (per decesso del partner)" as integer) as maschi_gia_unione_civile_decesso,
  ...
  try_cast("Femmine gia in unione civile (per scioglimento unione)" as integer) as femmine_gia_unione_civile_scioglimento,
  try_cast("Femmine gia in unione civile (per decesso del partner)" as integer) as femmine_gia_unione_civile_decesso,
